...
@router.post(
    ...
    responses = {
        400: {"description": "Invalid request or no publishable artifacts"},
        403: {"description": "The job belongs to another user"},
        404: {"description": "Job not found"},
        409: {"description": "Job is not a completed full run"},
        500: {"description": "Publishing failed unexpectedly"},
    },
)
def publish_job_dataset(
    ...
    artifact_path = status_artifact.strip() if isinstance(status_artifact, str) else ""
