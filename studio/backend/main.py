...
# OpenAI-compatible endpoints: mount only the OpenAI-compatible subset
# (/v1/chat/completions, /v1/models) at /v1 so external tools (Open WebUI,
# SillyTavern, etc.) can use the standard paths. Internal endpoints such as
# validate/load/unload stay available only under /api/inference.
